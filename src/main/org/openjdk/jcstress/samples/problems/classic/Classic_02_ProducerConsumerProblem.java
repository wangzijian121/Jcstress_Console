 ...
 * questions.
 */
package cc.zjyun.samples.problems.classic;
...
public class Classic_02_ProducerConsumerProblem {
    ...
    */
     ...
     */
    @JCStressTest
    @Outcome(id = "0, 0, 2", expect = Expect.ACCEPTABLE_INTERESTING, desc = "Producers overwrote each other's item.")
    @Outcome(expect = Expect.ACCEPTABLE, desc = "Producers didn't overwrite each other's item.")
    @State
