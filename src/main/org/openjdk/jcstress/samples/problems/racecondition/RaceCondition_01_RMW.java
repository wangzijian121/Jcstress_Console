 ...
 * questions.
 */
package cc.zjyun.samples.problems.racecondition;
...
public class RaceCondition_01_RMW {
    ...
    */
    ...
    @JCStressTest
    @Outcome(id = {"150, 100, 150"}, expect = Expect.ACCEPTABLE, desc = "actor2 completed first, then actor1 completed")
    @Outcome(id = {"250, 150, 150"}, expect = Expect.ACCEPTABLE, desc = "actor1 completed first, then actor2 completed")
    @Outcome(id = {"250, 100, 250"}, expect = Expect.ACCEPTABLE_INTERESTING, desc = "actors conflicted, actor1 won the race")
    @Outcome(id = {"250, 100, 100"}, expect = Expect.ACCEPTABLE_INTERESTING, desc = "actors conflicted, actor2 won the race")
    @State
    ...
    @Outcome(id = {"150, 100, 150"}, expect = Expect.ACCEPTABLE, desc = "actor2 completed first, then actor1 completed")
    @Outcome(id = {"250, 150, 150"}, expect = Expect.ACCEPTABLE, desc = "actor1 completed first, then actor2 completed")
    @Outcome(id = {"250, 100, 250"}, expect = Expect.FORBIDDEN, desc = "Cannot happen")
    @Outcome(id = {"250, 100, 100"}, expect = Expect.FORBIDDEN, desc = "Cannot happen")
    @State
