...
public class RaceCondition_02_CheckThenReact {
    ...
    */
    ...
    @JCStressTest
    @Outcome(id = {"true, false", "false, true"}, expect = Expect.ACCEPTABLE, desc = "Only one actors entered the section")
    @Outcome(id = {"true, true"}, expect = Expect.ACCEPTABLE_INTERESTING, desc = "Conflict: both actors entered the section")
    @State
    ...
    @JCStressTest
    @Outcome(id = {"true, false", "false, true"}, expect = Expect.ACCEPTABLE, desc = "Only one actors entered the section")
    @Outcome(id = {"true, true"},                 expect = Expect.FORBIDDEN, desc = "Conflict: both actors entered the section")
    @State
