...
public class RMW_10_FailureWitness {
    ...
    @JCStressTest
    @Outcome(id = "false, 0",                         expect = Expect.ACCEPTABLE_INTERESTING, desc = "Whoa")
    @Outcome(id = {"false, 1", "true, 0", "true, 1"}, expect = Expect.ACCEPTABLE, desc = "Trivial")
    @State
    ...
    @JCStressTest
    @Outcome(id = "false, 0",                         expect = Expect.FORBIDDEN,  desc = "Cannot happen")
    @Outcome(id = {"false, 1", "true, 0", "true, 1"}, expect = Expect.ACCEPTABLE, desc = "Trivial")
    @State
