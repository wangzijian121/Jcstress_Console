 ...
 * questions.
 */
package cc.zjyun.samples.primitives.rmw;
...
public class RMW_02_ContendedSuccess {
    ...
    @JCStressTest
    @Outcome(id = {"true, false", "false, true"}, expect = Expect.ACCEPTABLE, desc = "Trivial")
    @Outcome(id = "false, false",                 expect = Expect.FORBIDDEN,  desc = "Not even once")
    @Outcome(id = "true, true",                   expect = Expect.FORBIDDEN,  desc = "More than once")
    ...
    @JCStressTest
    @Outcome(id = {"true, false", "false, true"}, expect = Expect.ACCEPTABLE,             desc = "Trivial")
    @Outcome(id = "false, false",                 expect = Expect.ACCEPTABLE_INTERESTING, desc = "Not even once")
    @Outcome(id = "true, true",                   expect = Expect.FORBIDDEN,              desc = "More than once")
