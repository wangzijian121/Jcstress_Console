...
public class AdvancedJMM_15_VolatilesAreNotFences {
    ...
    @JCStressTest
    @State
    @Outcome(id = {"0, 0, 0", "1, 1, 1"},   expect = Expect.ACCEPTABLE,             desc = "Boring")
    @Outcome(id = {"0, .*, 1", "1, .*, 1"}, expect = Expect.ACCEPTABLE,             desc = "Irrelevant")
    @Outcome(id = "1, 0, 0",                expect = Expect.ACCEPTABLE_INTERESTING, desc = "Whoa")
    ...
    @Outcome(id = "0, 1",           expect = Expect.ACCEPTABLE, desc = "Plausible")
    @Outcome(id = "1, 0",           expect = Expect.FORBIDDEN,  desc = "Now forbidden")
