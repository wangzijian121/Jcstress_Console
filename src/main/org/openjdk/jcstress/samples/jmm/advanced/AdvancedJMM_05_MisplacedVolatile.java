...
public class AdvancedJMM_05_MisplacedVolatile {
    ...
    @JCStressTest
    @State
    @Outcome(id = {"-1", "42"}, expect = Expect.ACCEPTABLE,             desc = "Boring")
    @Outcome(id = "0",          expect = Expect.ACCEPTABLE_INTERESTING, desc = "Whoa")
    ...
    @State
    @Outcome(id = {"-1", "42"}, expect = Expect.ACCEPTABLE, desc = "Boring")
    @Outcome(id = "0",          expect = Expect.FORBIDDEN,  desc = "Illegal")
