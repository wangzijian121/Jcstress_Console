 ...
 * questions.
 */
package cc.zjyun.samples.jmm.basic;
...
public class BasicJMM_06_Causality {
    ...
    */
    ...
    @Outcome(id = "0, 1", expect = Expect.ACCEPTABLE, desc = "Caught in the middle: $x is visible, $y is not.")
    @Outcome(id = "1, 0", expect = Expect.ACCEPTABLE_INTERESTING, desc = "Seeing $y, but not $x!")
    @State
    ...
    @Outcome(id = "1, 1", expect = Expect.ACCEPTABLE, desc = "Doing both reads late.")
    @Outcome(id = "0, 1", expect = Expect.ACCEPTABLE, desc = "Caught in the middle: $x is visible, $y is not.")
    @Outcome(id = "1, 0", expect = Expect.FORBIDDEN, desc = "Seeing $y, but not $x!")
    @State
    ...
    @Outcome(id = "0, 0", expect = Expect.ACCEPTABLE, desc = "Doing both reads early.")
    @Outcome(id = "1, 1", expect = Expect.ACCEPTABLE, desc = "Doing both reads late.")
    @Outcome(id = "0, 1", expect = Expect.FORBIDDEN, desc = "Caught in the middle: $x is visible, $y is not.")
    @Outcome(id = "1, 0", expect = Expect.FORBIDDEN, desc = "Seeing $y, but not $x!")
    @State
