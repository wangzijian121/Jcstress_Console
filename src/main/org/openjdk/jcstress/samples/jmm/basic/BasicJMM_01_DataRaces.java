...
@JCStressTest
@Outcome(id = "null",                   expect = Expect.ACCEPTABLE, desc = "Not seeing the object yet")
@Outcome(id = "class java.lang.Object", expect = Expect.ACCEPTABLE, desc = "Seeing the object, valid class")
